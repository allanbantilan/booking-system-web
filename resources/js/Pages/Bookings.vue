...
<template>
    <DashboardLayout title="Available Bookings">
        <div class="-mx-4 -mt-8 -mb-8 sm:-mx-6 lg:-mx-8">
            <section class="border-b border-white/10 bg-white/5 backdrop-blur">
                <div class="mx-auto max-w-[1440px] px-6 py-8 sm:px-10 lg:px-16">
                    <h1 class="text-2xl font-black md:text-3xl lg:text-4xl">
                        Available Bookings
                    </h1>
            ...
            <section class="sticky top-0 z-10 border-b border-white/10 bg-slate-950/80 backdrop-blur-xl">
                <div class="mx-auto flex max-w-[1440px] flex-wrap items-end gap-4 px-6 py-4 sm:px-10 lg:px-16">
            ...
            <section class="mx-auto max-w-[1440px] px-6 py-8 sm:px-10 lg:px-16">
                <div v-if="bookings.length" class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <article
                        v-for="booking in bookings"
                        :key="booking.id"
                        class="group flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-white/20"
                        ...
                        <div class="p-5">
                            ...
                            >
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <span
                                        class="shrink-0 rounded-full border border-white/20 px-3 py-1 text-xs text-slate-200"
                                    >
            ...
            <section v-if="paginationLinks.length > 1" class="border-t border-white/10 bg-white/5 backdrop-blur">
                <div class="mx-auto flex max-w-[1440px] flex-wrap items-center justify-center gap-2 px-6 py-6 sm:px-10 lg:px-16">
                    <component
