...
<template>
    ...
    <div class="min-h-screen bg-ledger-bg text-ledger-text">
        ...
        <main class="mx-auto max-w-4xl px-4 pb-20 pt-32 sm:px-6">
            ...
            <article class="prose prose-slate mt-6 max-w-none rounded-lg border border-ledger-border bg-ledger-surface p-6 text-ledger-muted dark:prose-invert sm:p-10" v-html="policy" />
        </main>
    </div>
</template>
