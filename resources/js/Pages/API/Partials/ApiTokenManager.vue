    ...
    <div>
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="permission in availablePermissions" :key="permission">
                            <label class="flex items-center">
                                ...
                                <span class="ms-2 text-sm text-ledger-muted">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token" class="mt-4 bg-ledger-bg px-4 py-2 rounded font-mono text-sm text-ledger-muted break-all">
